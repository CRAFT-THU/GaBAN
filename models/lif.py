...
class LIF(Function):
    ...
    def declare(self):
        ...
        self.i_e = Variable("i_e", self.floatType)
        self.i_i = Variable("i_i", self.floatType)
        ...
        self.c_e = Const("c_e", self.floatType)
        self.c_i = Const("c_i", self.floatType)
        self.e_e = Const("e_e", self.floatType)
        self.e_i = Const("e_i", self.floatType)
    ...
    def activate(self):
        ...
        self.i_e = mux(refract, self.i_e, self.i_e * self.e_e)
        self.i_i = mux(refract, self.i_i, self.i_i * self.e_i)
        ...
        stall_i = refract | self.fire
        self.i_e = mux(stall_i, self.i_e, self.i_e + self.exc)
        self.i_i = mux(stall_i, self.i_i, self.i_i + self.inh)
